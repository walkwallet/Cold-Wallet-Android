package systems.v.coldwallet.ui.widget;
...
import systems.v.coldwallet.databinding.DialogContentVerifyBinding;
...
public class VerifyDialogFragment extends DialogFragment implements DialogInterface.OnClickListener {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        AlertDialog.Builder builder = new AlertDialog.Builder(getContext(), R.style.BasicAlertDialog_Dark);
        String title = getArguments().getString("title");
        mBinding = DataBindingUtil.inflate(LayoutInflater.from(getContext()), R.layout.dialog_content_verify, null, false);
